"""
Match up with a partner. One of you should solve the first problem, the other should solve the second.
...
# Problem 2:
# Write a function that takes in an argument. The argument should be the dictioary below, titled
# uncurved grades. You should iterate through every score in the attendance and curve it
# up by 10%. The homework should curve by 2%. The midterm one should be curved by 15%.
# The midterm two should be curved by 20%. Return a new variable called curved_grades
# with the newly curved values.
