...
First you must enable 2-Step Verification. After that, you will see the circled button appear. Click on it, select mail as the app, and your device of choice. You will use the autogenerated from the app password to authenticate the connection later in the code.
