...
First you must enable 2-Step Verification. If you have persistent issues running these steps with Google on the Pi, feel free to do this from your personal phone. After that, you will see the circled button appear. Click on it, select mail as the app, and your device of choice. You will use the code that is autogenerated from the app password to authenticate the connection later in the code.
