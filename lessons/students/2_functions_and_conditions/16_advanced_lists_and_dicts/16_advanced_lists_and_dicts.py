...
# "dict(key1=value1, key2=value2)". Also, the dictionary constructor can take as many arguments as the
...
# List comprehension is a means to create a new list based on the values of an existing iterable.
# The syntax for using list comprehension is "[expression for x in iterable_object]" where
# "expression" represents a value and "x" is each item in "iterable_object". In the example below we
# are using list comprehension to iterate through each number between 0 and 9, squaring the number,
...
# Conditionals can be added to list comprehensions. The conditional is added to the end of a list
...
# Python also allows for dictionary comprehension. Just as in list comprehension, dictionary
# comprehension is a means to create a new dictionary based on the values of two existing iterables.
...
i = 0 # This will act as a counter to keep track of the index position of each element
      # in "number_list"
...
# the ".items()" method is "for key, value in iterable:". Below is an example of using the
# ".items()" method.
...
var2 = "CSX"
if (var in listy): # This checks if the value of "var2", "CSX" is in the list, "listy".
  print(f"The string {var2} is in listy.")
else: # If "var2" isn't in listy, then the condition will return False and the "else" statement
      # will execute
  print(f"The string {var2} is not in listy.")

languages = {"italian": "Italy", "spanish": "Spain", "french": "France"}

var = "italian"
if (var in languages): # This checks if the value of "var", "italian" is in the dictionary,
                       # "languages".
  print(f"The string {var} is a key in languages.")

var2 = "mandarin"
if (var in languages): # This checks if the value of "var2", "mandarin" is in the dictionary,
                       # "languages".
  print(f"The string {var2} is a key in languages.")
else: # If "var2" isn't in languages, then the condition will return False and the "else" statement
      # will execute
  print(f"The string {var2} is not a key in languages.")
