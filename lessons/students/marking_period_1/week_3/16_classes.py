...
########################################################################################
    ...
    def format_class(self):
        ...
        s = ["----------",
             ...
             # curly braces to be used for replacement fields. See the link for 
             # reference:
...
def ask_user(message='', type=str):
    ...
    while not user_input:
        try:
            ...
            # If this recieves a value error, it will reiterate the same question until the input is 
            # satisfied.
            continue
    return user_input
​
