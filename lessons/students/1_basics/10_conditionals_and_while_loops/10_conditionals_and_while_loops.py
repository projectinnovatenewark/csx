...
rectangle_area = 100
if (rectangle_area > 50): # if "rectangle_area" is greater than 50, the print statement will run.
    print("This is a large rectangle")

# Another type of conditional statement is an "else statement". An "else statement" will only run if
# a paired "if statement" is false.
