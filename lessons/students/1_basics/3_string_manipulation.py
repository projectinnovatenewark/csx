...
# There are also functions that allow you to change the capitalization of the strings.
# The .upper() function makes strings uppercase and .lower() makes them lowercase.
...
# The startswith() funtion returns a boolean value (true/false) on whether or not a string begins with a certain
